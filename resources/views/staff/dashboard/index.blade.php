...
<style>
    ...
    .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 6px 18px rgba(233,69,96,0.4); }
</style>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th>Task</th><th>Room</th><th>Priority</th><th>Due Date</th><th>Status</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($task->priority == 'medium') <span class="badge bg-warning">Medium</span>
