                        ...
                        <form action="{{ route('admin.tasks.update', $task->id) }}" method="POST">
                            ...
                            @method('PUT')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="hidden" name="task_name" id="task_name_hidden" value="{{ old('task_name', $task->task_name) }}">
                                    <div class="dropdown">
                                            ...
                                            @foreach($staff as $member)
                                                <li class="dropdown-item px-2" style="background: transparent;">
                                                    <div class="form-check m-0">
                                                        <input class="form-check-input staff-checkbox" type="checkbox" name="staff_ids[]" value="{{ $member->id }}" id="staff_{{ $member->id }}" {{ in_array($member->id, old('staff_ids', $assignedStaffIds)) ? 'checked' : '' }} data-name="{{ $member->name }}" style="cursor: pointer;">
