<x-app-layout>
                        ...
                        <form action="{{ route('admin.admins.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div id="adminAgeError" style="color:#f87171; font-size:0.82rem; margin-top:4px; display:none;">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" id="adminAgeDisplay"
                                           class="form-control"
    ...
    <script>
        function calcAge() {
            const bd  = document.getElementById('adminBirthdate');
            const out = document.getElementById('adminAgeDisplay');
            const err = document.getElementById('adminAgeError');
